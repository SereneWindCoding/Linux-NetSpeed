...
installbbr(){
	...
	if [[ "${release}" == "centos" ]]; then
		rpm --import https://ghproxy.com/https://${github}/bbr/${release}/RPM-GPG-KEY-elrepo.org
		yum install -y https://ghproxy.com/https://${github}/bbr/${release}/${version}/${bit}/kernel-ml-${kernel_version}.rpm
		yum remove -y kernel-headers
		yum install -y https://ghproxy.com/https://${github}/bbr/${release}/${version}/${bit}/kernel-ml-headers-${kernel_version}.rpm
		yum install -y https://ghproxy.com/https://${github}/bbr/${release}/${version}/${bit}/kernel-ml-devel-${kernel_version}.rpm
